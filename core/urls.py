...
urlpatterns = [
    ...
    path('event/<pk>/detail/', views.event_detail, name='event_detail'),
    path('event/<pk>/book/', views.book_now_event, name='book_now_event'),
    path('locations/', views.location, name='location'),
    path('location/<pk>/detail/', views.location_detail, name='location_detail'),
    path('location/<pk>/book/', views.book_now_location, name='book_now_location'),
